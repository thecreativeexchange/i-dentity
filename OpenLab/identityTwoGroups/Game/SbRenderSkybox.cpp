...
void SbRenderSkybox::Render()
{
	...
	m_pFrontMaterial->Render( RsPT_TriangleStrip, pVertex, 4, 0 );
	...
	// Render these triangles
	m_pRightMaterial->Render( RsPT_TriangleStrip, pVertex, 4, 0);
	...
	// Render these triangles
	m_pLeftMaterial->Render( RsPT_TriangleStrip, pVertex, 4, 0 );
	...
	m_pUpMaterial->Render( RsPT_TriangleStrip, pVertex, 4, 0 );
	...
	m_pBackMaterial->Render( RsPT_TriangleStrip, pVertex, 4, 0 );
}
